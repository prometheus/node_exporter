...
func NewBcacheCollector() (Collector, error) {
	return &bcacheCollector{
		...
		descs: map[string]typedDesc{
			...
			"bypassed_bytes": {
				prometheus.NewDesc(
					prometheus.BuildFQName(Namespace, "bcache", "bypassed_5min"),
			...
			"dirty_data_bytes": {
				prometheus.NewDesc(
					prometheus.BuildFQName(Namespace, "bcache", "dirty_data"),
			...
			"metadata_written_bytes": {
				prometheus.NewDesc(
					prometheus.BuildFQName(Namespace, "bcache", "metadata_written"),
			...
			"written_bytes": {
				prometheus.NewDesc(
					prometheus.BuildFQName(Namespace, "bcache", "written"),
