...
func TestMdadmStats(t *testing.T) {
	...
	*procPath = "fixtures/proc"
	testcase := `# HELP node_md_blocks Total number of blocks on device.
        ...
        node_md_blocks{device="md125"} 614336
        ...
        node_md_blocks_synced{device="md125"} 614336
        ...
        node_md_disks{device="md120",state="removed"} 0
        node_md_disks{device="md120",state="spare"} 0
        node_md_disks{device="md125",state="active"} 1
        node_md_disks{device="md125",state="failed"} 0
        node_md_disks{device="md125",state="removed"} 1
        node_md_disks{device="md125",state="spare"} 0
        node_md_disks{device="md126",state="active"} 2
        node_md_disks{device="md126",state="failed"} 0
        node_md_disks{device="md126",state="removed"} 0
        ...
        node_md_disks{device="md127",state="removed"} 0
        ...
        node_md_disks{device="md201",state="removed"} 0
        ...
        node_md_disks_required{device="md125"} 2
        ...
        node_md_state{device="md125",state="active"} 1
        node_md_state{device="md125",state="check"} 0
        node_md_state{device="md125",state="inactive"} 0
        node_md_state{device="md125",state="recovering"} 0
        node_md_state{device="md125",state="resync"} 0
