...
const (
	defaultCollectors = "conntrack,cpu,diskstats,entropy,filefd,filesystem,inodestate,loadavg,mdadm,meminfo,netdev,netstat,sockstat,stat,textfile,time,uname,vmstat"
)
