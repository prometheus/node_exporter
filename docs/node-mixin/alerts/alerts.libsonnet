        ...
        rules: [
          {
            ...
            expr: |||
              ...
              and
                predict_linear(node_filesystem_avail_bytes{%(nodeExporterSelector)s,%(fsSelector)s}[6h], %(nodeWarningWindowHours)s*60*60) < 0
              and
          ...
          },
          {
            ...
            expr: |||
              ...
              and
                predict_linear(node_filesystem_avail_bytes{%(nodeExporterSelector)s,%(fsSelector)s}[6h], %(nodeCriticalWindowHours)s*60*60) < 0
              and
                node_filesystem_readonly{%(nodeExporterSelector)s,%(fsSelector)s} == 0
              )
            ||| % $._config,
          ...
          },
          {
            ...
            expr: |||
              ...
              and
                predict_linear(node_filesystem_files_free{%(nodeExporterSelector)s,%(fsSelector)s}[6h], %(nodeWarningWindowHours)s*60*60) < 0
              and
                node_filesystem_readonly{%(nodeExporterSelector)s,%(fsSelector)s} == 0
              )
            ||| % $._config,
          ...
          },
          {
            ...
            expr: |||
              ...
              and
                predict_linear(node_filesystem_files_free{%(nodeExporterSelector)s,%(fsSelector)s}[6h], %(nodeCriticalWindowHours)s*60*60) < 0
              and
                node_filesystem_readonly{%(nodeExporterSelector)s,%(fsSelector)s} == 0
              )
            ||| % $._config,
