// This file is generated, do not manually edit.
{
  ...
  CellValues+:
    {
      ...
      withDecimals(value): { CellValues+: { decimals: value } },
      '#withUnit': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Controls the cell value unit' } },
      withUnit(value): { CellValues+: { unit: value } },
    },
  '#withExemplarConfig': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls exemplar options' } },
  withExemplarConfig(value): { ExemplarConfig: value },
  '#withExemplarConfigMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls exemplar options' } },
  withExemplarConfigMixin(value): { ExemplarConfig+: value },
  ExemplarConfig+:
    {
      '#withColor': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Sets the color of the exemplar markers' } },
      withColor(value): { ExemplarConfig+: { color: value } },
    },
  '#withFilterValueRange': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls the value filter range' } },
  withFilterValueRange(value): { FilterValueRange: value },
  ...
  withFilterValueRangeMixin(value): { FilterValueRange+: value },
  FilterValueRange+:
    {
      ...
      withGe(value): { FilterValueRange+: { ge: value } },
      ...
      withLe(value): { FilterValueRange+: { le: value } },
    },
  '#withHeatmapColorMode': { 'function': { args: [{ default: null, enums: ['opacity', 'scheme'], name: 'value', type: 'string' }], help: 'Controls the color mode of the heatmap' } },
  withHeatmapColorMode(value): { HeatmapColorMode: value },
  '#withHeatmapColorOptions': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls various color options' } },
  withHeatmapColorOptions(value): { HeatmapColorOptions: value },
  ...
  withHeatmapColorOptionsMixin(value): { HeatmapColorOptions+: value },
  HeatmapColorOptions+:
    {
      ...
      withScale(value): { HeatmapColorOptions+: { scale: value } },
      '#withScheme': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Controls the color scheme used' } },
      withScheme(value): { HeatmapColorOptions+: { scheme: value } },
      '#withSteps': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'integer' }], help: 'Controls the number of color steps' } },
      withSteps(value): { HeatmapColorOptions+: { steps: value } },
    },
  '#withHeatmapColorScale': { 'function': { args: [{ default: null, enums: ['linear', 'exponential'], name: 'value', type: 'string' }], help: 'Controls the color scale of the heatmap' } },
  withHeatmapColorScale(value): { HeatmapColorScale: value },
  '#withHeatmapLegend': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls legend options' } },
  withHeatmapLegend(value): { HeatmapLegend: value },
  '#withHeatmapLegendMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls legend options' } },
  withHeatmapLegendMixin(value): { HeatmapLegend+: value },
  HeatmapLegend+:
    {
      '#withShow': { 'function': { args: [{ default: true, enums: null, name: 'value', type: 'boolean' }], help: 'Controls if the legend is shown' } },
      withShow(value=true): { HeatmapLegend+: { show: value } },
    },
  '#withHeatmapTooltip': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls tooltip options' } },
  withHeatmapTooltip(value): { HeatmapTooltip: value },
  '#withHeatmapTooltipMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls tooltip options' } },
  withHeatmapTooltipMixin(value): { HeatmapTooltip+: value },
  HeatmapTooltip+:
    {
      '#withShow': { 'function': { args: [{ default: true, enums: null, name: 'value', type: 'boolean' }], help: 'Controls if the tooltip is shown' } },
      withShow(value=true): { HeatmapTooltip+: { show: value } },
      ...
      withYHistogram(value=true): { HeatmapTooltip+: { yHistogram: value } },
    },
  '#withRowsHeatmapOptions': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls frame rows options' } },
  withRowsHeatmapOptions(value): { RowsHeatmapOptions: value },
  '#withRowsHeatmapOptionsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Controls frame rows options' } },
  withRowsHeatmapOptionsMixin(value): { RowsHeatmapOptions+: value },
  RowsHeatmapOptions+:
    {
      '#withLayout': { 'function': { args: [{ default: null, enums: ['le', 'ge', 'unknown', 'auto'], name: 'value', type: 'string' }], help: '' } },
      withLayout(value): { RowsHeatmapOptions+: { layout: value } },
      ...
      withValue(value): { RowsHeatmapOptions+: { value: value } },
    },
  '#withYAxisConfig': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Configuration options for the yAxis' } },
  withYAxisConfig(value): { YAxisConfig: value },
  '#withYAxisConfigMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Configuration options for the yAxis' } },
  withYAxisConfigMixin(value): { YAxisConfig+: value },
  YAxisConfig+:
    {
      '#withAxisCenteredZero': { 'function': { args: [{ default: true, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withAxisCenteredZero(value=true): { YAxisConfig+: { axisCenteredZero: value } },
      '#withAxisColorMode': { 'function': { args: [{ default: null, enums: ['text', 'series'], name: 'value', type: 'string' }], help: 'TODO docs' } },
      withAxisColorMode(value): { YAxisConfig+: { axisColorMode: value } },
      '#withAxisGridShow': { 'function': { args: [{ default: true, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withAxisGridShow(value=true): { YAxisConfig+: { axisGridShow: value } },
      '#withAxisLabel': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: '' } },
      withAxisLabel(value): { YAxisConfig+: { axisLabel: value } },
