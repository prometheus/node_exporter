...
* **value** (`string`)
   - valid values: `"value"`, `"background"`, `"background_solid"`, `"none"`

TODO docs
#### fn options.withGraphMode

```jsonnet
options.withGraphMode(value)
```

PARAMETERS:

* **value** (`string`)
   - valid values: `"none"`, `"line"`, `"area"`

TODO docs
#### fn options.withJustifyMode

```jsonnet
options.withJustifyMode(value)
```

PARAMETERS:

* **value** (`string`)
   - valid values: `"auto"`, `"center"`
...
* **value** (`string`)
   - valid values: `"auto"`, `"value"`, `"value_and_name"`, `"name"`, `"none"`
