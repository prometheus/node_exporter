...
func main() {
	...
	absCollectorDir, err := filepath.Abs(collectorDir)
	if err != nil {
	...
	if err := os.MkdirAll("docs/collectors", 0755); err != nil {
		fmt.Fprintf(os.Stderr, "Error creating directory docs/collectors: %v\n", err)
		os.Exit(1)
	}
